...
<div id="wrap">
    ...
    <div id="main-content">
      <h1>404 ERROR</h1>
      <h4 class="mb-5"> Η σελίδα δεν βρέθηκε </h4>

      <p>Δυστυχώς η σελίδα που ψάχνετε δεν υπάρχει</p>

      <p class="mb-5">Πηγαίντε πίσω ή στην αρχική σελίδα</p>

      <div class="row justify-content-start">
        <button onclick="window.history.back();" id="backpage"><i class="fas fa-angle-left"></i> Πίσω</button>
        <a class="ml-3" id="mainpagebutton" href="<?php echo home_url();?>"> Αρχική σελίδα </a>
      </div>
